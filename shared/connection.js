...
const database = process.env.DatabaseName || 'nether';
...
*/
const connectionUri = (!user || !pass) ? 'mongodb://' + host + '/' + database : util.format('mongodb://%s:%s@%s:%s/%s', user, pass, host, port, database);
